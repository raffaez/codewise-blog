...
function Home() {
  return (
    <div className="flex items-start flex-col space-y-5 mx-10">
      <Title title="code wise" size="text-5xl md:text-8xl" />
      <div className="flex flex-col lg:flex-row justify-center bg-blue-600/20 dark:bg-blue-600/10 rounded-lg">
        <img
          ...
          alt=""
          className="w-[640px] md:w-full lg:h-96 object-cover rounded-lg"
        />
        <div className="px-5 flex flex-col space-y-2 md:space-y-5 lg:space-y-1 xl:space-y-5 justify-center py-3">
          ...
          <p className="font-poppins text-blue-700 dark:text-emerald-400 text-4xl md:text-5xl xl:text-6xl md:tracking-widest lg:tracking-wider font-semibold">
            Step-by-Step Tutorials for Every Level
          </p>
          <p className="text-blue-800/70 dark:text-gray-50/80 text-xl lg:text-lg xl:text-2xl">
